...
<body>
  <div class="p-4" style="position:absolute; z-index: 2">
  ...
  <div class="welcome d-flex justify-content-center flex-column">
    <div class="inner-wrapper mt-auto mb-auto">
      ...
      <h2><p class="slide-in success-message" style="color: #3c3d29; font-family: Lora;"><?php echo $Success; ?></p></h2>
      <div class="action-links slide-in">
        <a href=" cliente/Nostale.exe" class="btn btn-primary btn-pill align-self-center mr-2">
