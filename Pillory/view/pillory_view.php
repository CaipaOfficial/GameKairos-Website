        ...
        <div class="row p-5">
          <table class="table table-dark col-10">
            ...
            if ($_POST['name_pillory']) {
              ...
              $sql = "SELECT * FROM PenaltyLog WHERE PenalityLogId > 1264";
              ...
              while ($row = sqlsrv_fetch_array( $result, SQLSRV_FETCH_ASSOC )) {
                ...
                echo "<tr><td>$id</td><td>$CharName</td><td>$AdminName</td><td>".$DateStart['date']."</td><td>".$DateEnd['date']."</td><td>$Penalty</td><td>$Reason</td></tr>";
